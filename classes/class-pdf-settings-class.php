                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                ...
                                <img class="help_tip" data-tip="<?php _e("If you have problems with PDFs turn on debugging. DO NOT leave this option on, the log will get very large very quickly.", 'woocommerce-pdf-invoice' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                ...
                $GLOBALS['WC_pdf_functions'] = new WC_pdf_functions();
                 ...
                 if ( $woocommerce_pdf_invoice_options['pdf_create_invoices_for_old'] == 1 ) {
                    ...
                    foreach ( $line_items as $item ) {
                        ...
                        if ( sanitize_title( $order_status ) == 'completed' && get_post_meta($item->ID, '_invoice_number', TRUE) == '' ) {
